...
<head>
	...
	<style>
		...
		.masuk a {
			margin: 10px;
			/* Tambahkan nilai sesuai dengan jarak yang diinginkan */
				...
				<div class="row flex-grow">
					<div class="col-lg-4 mx-auto">
						<div class="auth-form-light text-left p-5">
							<div class="masuk">
								<center>
									<a href="<?php echo site_url('auth/register'); ?>">
										<button type="button" class="btn btn-secondary">Staf</button>
									</a>
									<a href="<?php echo site_url('auth/daftar'); ?>">
										<button type="button" class="btn btn-light">Umum</button>
									</a>
							...
							<!-- Contoh tampilan notifikasi pada halaman register -->
							...
							<form action="" method="POST" class="pt-3">
								...
								<div class="form-group">
									<input type="text" class="form-control form-control-lg" placeholder="tempat kerja" name="tempat_kerja" value="<?php echo set_value('tempat_kerja'); ?>" required>
								</div>
								<div class="mt-3">
									<button type="submit" name="kirim" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">Tambah Akun</button>
								</div>
								<div class="text-center mt-4 font-weight-light"> Sudah Punya Akun? <a href="<?php echo site_url('auth/login'); ?>" class="text-primary">Masuk</a></div>
							</form>
						</div>
					</div>
				</div>
