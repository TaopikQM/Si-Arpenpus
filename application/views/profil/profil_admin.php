            ...
            <div class="container">
				<center>
					<div class="room-cardpro">
						<?php echo form_open('profil/profil_admin'); ?>
							<!-- profil.php -->
						<div class="profil-container">
							<center>
								<div class="top-pro">
									<div class="profil-picture"> 
										<?php echo strtoupper(substr($profil_admin['nama'], 0, 1)); ?>
									</div>
								</div>
							</center>
							<div class="profile-name">
								<h1><?php echo $profil_admin['nama']; ?></h1>
							</div>
							<div class="profile-info">
								<p>Email		: <?php echo $profil_admin['email']; ?></p>
								<p>Peran		: <?php echo $profil_admin['peran']; ?></p>	
