                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <form action="" method="POST" class="pt-3">
								...
								<div class="form-group">
                                    <input type="text" class="form-control form-control-lg" placeholder="jabatan" name="jabatan" value="<?php echo set_value('jabatan'); ?>" required>
                                </div>
								<div class="form-group">
                                    <input type="text" class="form-control form-control-lg" placeholder="nip" name="nip" value="<?php echo set_value('nip'); ?>" required>
                                </div>
                                <div class="mt-3">
