								...
								<div id="DataTables_Table_0_wrapper" class=" dataTables_wrapper">
									<div class="datatable-header">
										...
										<div class="dt-buttons">  
											<a class="btn btn-info btn-raised btn-sm buttons-print" tabindex="0" aria-controls="DataTables_Table_SMA" title="Unduh PDF" href="assets/pdf/SI-ARPENPUS_DataSma.pdf" download="SI-ARPENPUS_DataSma.pdf">
												<span>
													UNDUH
										...
										<table class="table table-hover table-striped dataTable" id="DataTables_Table_SMA" role="grid"> 
											<thead>
												<tr role="row">
													...
													<th class="text-center sorting" rowspan="2" tabindex="0" aria-controls="DataTables_Table_SMA" colspan="1" aria-label="Wilayah: activate to sort column ascending">Wilayah</th>
													
													<th class="text-center" colspan="3" rowspan="1">SMA</th>
												</tr>
												<tr role="row">
													
													<th class="text-right sorting" tabindex="0" aria-controls="DataTables_Table_SMA" rowspan="1" colspan="1" aria-label="Jml: activate to sort column ascending">Jml</th>
													<th class="text-right sorting" tabindex="0" aria-controls="DataTables_Table_SMA" rowspan="1" colspan="1" aria-label="N: activate to sort column ascending">N</th>
													<th class="text-right sorting" tabindex="0" aria-controls="DataTables_Table_SMA" rowspan="1" colspan="1" aria-label="S: activate to sort column ascending">S</th>
												</tr>
											</thead>
											<tbody>
												<?php
